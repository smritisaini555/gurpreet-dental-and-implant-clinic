...
const CounterItem = ({ targetValue, label, icon, isHighlight, shouldCount }) => {
    const [count, setCount] = useState(0);
    const [hasStarted, setHasStarted] = useState(false);
    const elementRef = useRef(null);

    const finalNumber = shouldCount ? parseInt(targetValue.replace(/[^0-9]/g, '')) : 0;
    ...
    return (
        <div className={`counter-item ${isHighlight ? 'highlight' : ''}`} ref={elementRef}>
...
const WhyUs = () => {
    ...
    const points = [
        { title: "A Legacy of Trust", desc: "Nearly three decades of specialized care for every age group." },
        { title: "Advanced Diagnostic Technology", desc: "Featuring Digital OPG for high-fidelity treatment planning." },
        { title: "Specialized Care", desc: "Expert-led treatments in Dental Implants, RCT, and Laser Dentistry." },
        { title: "Patient-Centric", desc: "Streamlined appointments and rigorous sanitization protocols." }
    ];
...
We maintain the highest standards of cleanliness and sterility, and our staff is specially trained in Universal (Standard) Precautions.
                    ...
                    <div className="image-side">
                        <div className="img-container">
                            <img src="https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?q=80&w=2070&auto=format&fit=crop" alt="Clinic" />
                ...
                <div className="stats-main-container">
                    <div className="stats-left-text">
                        ...
                        <p className="stats-desc">
                            At Gurpreet Dental and Implant Centre, your smile is our priority. We look forward to welcoming you to our family and providing you with the highest level of dental care.
                        </p>
                        <button className="book-btn" onClick={handleBookAppointment}>BOOK YOUR APPOINTMENT TODAY <span>→</span></button>
                    </div>
